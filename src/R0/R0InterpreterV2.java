...
public class R0InterpreterV2 {
    ...
    public static R0Literal R0Interpret(R0Program p) {
        return ExpressionInterpret(p.getExp());
    }
    
    
    public static R0Literal ExpressionInterpret(R0Expression e){
        Map <String, R0Literal> varList = new HashMap<>();
        return ExpressionInterpretRecursive(e,varList);
    }
    public static R0Literal ExpressionInterpretRecursive(R0Expression e, Map <String, R0Literal> varList){
        //int case
